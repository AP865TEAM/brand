    ...
    <main id="top" className="fullpage-story">
      ...
      <section className="full-page cover-page" aria-labelledby="cover-title">
        <figure className="opening-visual">
          ...
          <figcaption><span>Brand direction / {foundation.status}</span><h1 id="cover-title">{foundation.title}</h1><div><p>Core values, before identity.</p><span>공간 무드 이미지 · 실제 시공 이미지 아님</span></div></figcaption>
        </figure>
      </section>
