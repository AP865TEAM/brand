...
export const keywords = [
  ...
  { keyword: 'High-end', korean: '드러내지 않아도 느껴지는 품격.', sources: ['01', '03', '05', '06', '09'], interpretation: 'AP865의 품격은 보이지 않는 기준에서 완성됩니다. 정교한 의학적 판단과 세심한 경험 설계로, 시간이 지나도 신뢰할 수 있는 가치를 추구합니다.', expression: '명료한 형태 · 절제된 대비 · 정교한 마감' },
];
...
export const logoProposals: LogoProposal[] = [
  {
    ...
    comment: ['공간의 질서를 닮은 수직의 리듬.', '정교한 비례로 완성하는 하이엔드.'],
    ...
    direction: 'AP865의 공간과 브랜드가 같은 형태 언어를 공유하는 방향입니다. 세로의 긴장감과 절제된 장식으로, 전문성과 하이엔드의 무게감을 함께 제안합니다.',
    values: ['High-end — 정제된 비례와 공간적 존재감', 'Private — 내부를 감싸는 스크린을 연상시키는 구조'],
  ...
  },
  {
    ...
    comment: ['유려한 이니셜에 담긴 클래식한 품격.', '오래 기억되는 하이엔드 모노그램.'],
    ...
    direction: '유행의 속도보다 오래 지속되는 취향과 신뢰에 무게를 두는 방향입니다. 사적인 공간과 개인화된 서비스에 어울리는, 차분하지만 기억되는 하이엔드 이미지를 제안합니다.',
    values: ['High-end — 클래식한 획 대비와 완성도', 'Private — 개인의 이니셜을 연상시키는 상징성'],
  ...
  },
  {
    ...
    values: ['Concierge — 끊기지 않고 이어지는 관계와 관리', 'High-end — 균형 잡힌 곡선에서 읽히는 장식적 품격'],
  ...
  },
  {
    ...
    direction: '고정된 하나의 표정보다 규칙 안에서 변화하는 아이덴티티를 제안합니다. 개인별로 달라지는 케어를 시스템의 유연함으로 설명할 수 있지만, 하이엔드의 절제감을 지키는 운영 규칙이 중요합니다.',
